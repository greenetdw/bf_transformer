...
import com.beifeng.transformer.mr.inbound.InboundRunner;
...
public class InboundBounceRunner extends TransformerBaseRunner {
    ...
    protected Filter fetchHbaseFilter() {
        ...
        filterList.addFilter(new SingleColumnValueFilter(InboundBounceMapper.family, Bytes.toBytes(EventLogConstants.LOG_COLUMN_NAME_EVENT_NAME), CompareFilter.CompareOp.EQUAL, Bytes.toBytes(EventLogConstants.EventEnum.PAGEVIEW.alias)));
        return filterList;
    }
}
